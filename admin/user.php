...
<main class="max-w-4xl mx-auto px-4 sm:px-6 py-12">
  <h2 class="font-serif text-3xl text-stone-900 text-center mb-8">Registered Users</h2>
    ...
    <table class="w-full text-sm text-center">
      <thead class="bg-stone-900 text-white">
        <tr>
          ...
          <th class="py-3 px-3 font-medium">Username</th>
          <th class="py-3 px-3 font-medium">Email</th>
          <th class="py-3 px-3 font-medium">Phone</th>
        </tr>
      </thead>
      <tbody class="divide-y divide-stone-200">
        ...
        <tr class="hover:bg-stone-50 transition-colors">
          ...
          <td class="py-3 px-3 text-stone-900 font-medium"><?php echo $row['username']; ?></td>
          <td class="py-3 px-3 text-stone-600"><?php echo $row['useremail']; ?></td>
          <td class="py-3 px-3 text-stone-600"><?php echo $row['usernumber']; ?></td>
        </tr>
        <?php endwhile; ?>
      </tbody>
    </table>
